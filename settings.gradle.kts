...
include(":data-ble-api")
include(":data-ble-impl")
include(":data-executor-api")
include(":data-executor-impl")
include(":data-mcp-api")
include(":data-mcp-impl")
...
include(":presentation-feature-command")
include(":presentation-feature-preset")
include(":presentation-feature-devices")
